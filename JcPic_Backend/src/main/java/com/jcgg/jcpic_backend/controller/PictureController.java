...
import com.jcgg.jcpic_backend.manager.auth.annotation.SaSpaceCheckPermission;
import com.jcgg.jcpic_backend.api.aliyunai.AliYunAiApi;
import com.jcgg.jcpic_backend.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.jcgg.jcpic_backend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.jcgg.jcpic_backend.api.imagesearch.ImageSearchApiFacade;
...
import com.jcgg.jcpic_backend.manager.auth.model.SpaceUserPermissionConstant;
...
import com.jcgg.jcpic_backend.model.vo.PictureTagCategory;
...
//    @AuthCheck(mustRole = UserConstant.DEFAULT_ROLE)
    ...
    public BaseResponse<Boolean> updatePicture(@RequestBody PictureUpdateRequest pictureUpdateRequest,HttpServletRequest request) {
        ThrowUtils.throwIf(
                pictureUpdateRequest == null || pictureUpdateRequest.getId() <= 0,
                ErrorCode.PARAMS_ERROR
        );
        // 将实体类和 DTO 进行转换
...
//            }
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> tagList = Arrays.asList("默认", "搞笑", "生活", "高清", "艺术", "校园", "背景", "明日方舟", "创意");
        List<String> categoryList = Arrays.asList("模板", "封面", "表情包", "素材", "海报", "全家福");
